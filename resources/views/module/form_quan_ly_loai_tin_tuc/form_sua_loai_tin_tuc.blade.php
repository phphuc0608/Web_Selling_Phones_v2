...
<div class="col-md-6 p-3">
  <div class="form-group">
    ...
    <input readonly type="text" class="form-control" name="ma_loai_tin_tuc" id="ma_loai_tin_tuc" value="{{$loai_tin_tuc->ma_loai_tin_tuc}}">
</div>
  <div class="form-group">
    <label for="ten_loai_tin_tuc">Tên loại tin tức</label>
    <input type="text" class="form-control require" name="ten_loai_tin_tuc" id="ten_loai_tin_tuc" value="{{$loai_tin_tuc->ten_loai_tin_tuc}}">
  </div>
